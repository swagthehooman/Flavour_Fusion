  ...
  return (
    <footer className="flex flex-col items-center mt-16">
        <div className="flex justify-evenly w-1/3 mb-4">
          <img src="/images/instagram.png" alt="socials" className="w-8"/>
          <img src="/images/github.png" alt="socials" className="w-8"/>
          <img src="/images/facebook.png" alt="socials" className="w-8"/>
          <img src="/images/twitter.png" alt="socials" className="w-8"/>
        </div>
